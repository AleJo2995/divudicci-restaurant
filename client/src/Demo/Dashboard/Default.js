                                ...
                                <div className="row align-items-center justify-content-center card-active">
                                    <div className="col-12">
                                        <OverlayTrigger key={1} overlay={<Tooltip>{'Administrar'}</Tooltip>}>
                                            <Button className="col-12" variant={'outline-secondary'}><UcFirst text={'Administrar'} /></Button>
                                        </OverlayTrigger>
                                    </div>
                                </div>
                            </Card.Body>
                                ...
                                <div className="row align-items-center justify-content-center card-active">
                                    <div className="col-12">
                                        <OverlayTrigger key={1} overlay={<Tooltip>{'Manejar'}</Tooltip>}>
                                            <Button className="col-12" variant={'outline-success'}><UcFirst text={'Manejar'} /></Button>
                                        </OverlayTrigger>
                                    </div>
                                </div>
                            </Card.Body>
                        ...
                        <Card className='card-social'>
                            ...
                            <Card.Body>
                                <div className="row align-items-center justify-content-center card-active">
                                    <div className="col-12">
                                        <OverlayTrigger key={1} overlay={<Tooltip>{'Administrar'}</Tooltip>}>
                                            <Button className="col-12" variant={'outline-danger'}><UcFirst text={'Administrar'} /></Button>
                                        </OverlayTrigger>
                                    </div>
                                </div>
                            </Card.Body>
                        ...
                        <Card className='card-social'>
                            ...
                            <Card.Body>
                                <div className="row align-items-center justify-content-center card-active">
                                    <div className="col-12">
                                        <OverlayTrigger key={1} overlay={<Tooltip>{'Administrar'}</Tooltip>}>
                                            <Button className="col-12" variant={'outline-warning'}><UcFirst text={'Administrar'} /></Button>
                                        </OverlayTrigger>
                                    </div>
                                </div>
                            </Card.Body>
