...
class Users extends React.Component {
    ...
    createUser() {
        ...
        axios.get(this.state.configUrl + '/consecutives/get/lastConsecutive?type=Usuarios')
            .then((response) => {
                // handle success
                const consecutive = response.data;
                let updateActualValue = {};
                if(consecutive.actualValue === undefined || consecutive.actualValue === null){
                    updateActualValue = { actualValue: consecutive.initialValue + 1}
                } else {
                    updateActualValue = { actualValue: consecutive.actualValue + 1}
                }
                newUser.code = consecutive.code + updateActualValue.actualValue;
                axios.all([
                    axios.patch(this.state.configUrl + '/consecutives/update/lastConsecutive?type=Usuarios', updateActualValue),
                ...
                <Row>
                    <Col>
                        ...
                        <Tabs defaultActiveKey="home">
                            ...
                            <Tab eventKey="contact" title="Eliminar Usuario">
